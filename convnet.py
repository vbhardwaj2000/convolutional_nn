...
with tf.Session() as sess:
    ...
    while True:
        ...
        batch_training_data, batch_training_labels = dataUtils.getCIFAR10Batch(is_eval=False, batch_size=300)
        ...
        if step_count % 10 == 0:
            ...
            batch_test_data, batch_test_labels = dataUtils.getCIFAR10Batch(is_eval=True, batch_size=300)
